...
<%
    ...
    List<Activity> threeActivityList = (List<Activity>) request.getAttribute("threeActivityList");
...
<section id="feature" class="transparent-bg">
    <div class="container">
        <div class="center wow fadeInDown">
            <h2 style="color:purple">展厅活动</h2>
        </div>

        <div class="row">

            <% for(Activity n : threeActivityList){ %>

            <div class="col-md-4 wow fadeInDown">
                <div class="clients-comments text-center">
                    <a href="/ActivityIntroduction/find?title=<%=n.getActivityId() %>">
                        <img src="http://[2001:da8:270:2021::71]:8082/image/showImg?path=*<%=n.getActivityImage().replace("\\","*")%>" class="img-circle" alt=""></a>
                    <h3><%=n.getActivityTitle() %></h3>
                    <h4><%=n.getActivityContext() %></h4>
                </div>
            </div>
            <% } %>
        </div>
        ...
        <div class="get-started center wow fadeInDown" style="text-align:left;margin-top:-40px">
            ...
            <div class="row" style="margin-left:30px">
                <p style="color:purple;margin-left:30px;font-size:25px">全部活动</p>
            </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-left:60px">
                    <ul>
                        ...
                        <li><p onclick="change(<%=n.getActivityId()%>)" style="font-size:18px;cursor:pointer"><%=n.getActivityTitle() %></p></li>
                        <% } %>
                    </ul>
...
<script type="text/javascript">
    function change1(){
        var page = <%=pageNum%>;
        window.location.href='/activity/find?pageLast='+page;
    }

    function change2(){
        var page = <%=pageNum %>;
        window.location.href='/activity/find?pageNext='+page;
    }

    function change(activityId){
        window.location.href='/ActivityIntroduction/find?title='+activityId;
    }
</script>
</body>
</html>