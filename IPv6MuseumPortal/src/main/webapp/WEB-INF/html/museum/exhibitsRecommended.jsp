...
<section id="blog" class="container">
    ...
    <div class="blog">
            ...
            <div class="widget categories">
                <div class="row">
                    <ul class="blog_category">
                        <li><a id="ttt1" title="" href="#" onclick="select1()" >收藏次数</a></li>
                        <li><a id="ttt2" title="" href="#" onclick="select2()">浏览次数</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="tt" class="row" >
            <div class="col-md-10">
                <div class="blog-item">
                        <iframe onclick="select()" id="ifr" scrolling="no" frameborder=0 style="width:800px;height:1320px" src="/Exhibition/recommended">
                        </iframe>
                    </div>
                </div><!--/.blog-item-->
...
<script type="text/javascript">
    var Link;
    function select1(){
        var ii = "Exhibits_upvote";
        var ll = document.getElementById("ifr");
        ll.src = "/Exhibition/recommended.do?type="+ii;
        return ll.src;
    }
    function select2(){
        var ii = "Exhibits_browse";
        var ll = document.getElementById("ifr");
        ll.src = "/Exhibition/recommended.do?type="+ii;
        return ll.src;		}
