...
<div class="container">
    <div class="row" style="text-align:center">
        <h1 style="color:black">路线推荐</h1>
    </div>
    <div class="row" style="margin-top:30px"></div>
    <div class="row">
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
            <div class="row">1号厅</div>
            <div class="row">2号厅</div>
            <div class="row">3号厅</div>
            <div class="row">4号厅</div>
            <div class="row">5号厅</div>
            <div class="row">6号厅</div>
            <div class="row">
                <button id="001" onclick="huantu()">网站推荐</button>
            </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="text-align:center">
            <img id="007" style="border-radius: 10px" src="http://[2001:da8:270:2021::71]:8082/image/showImg?path=*download*xsg2.jpg" alt="" />
        </div>
    </div>
...
<script type="text/javascript">
    function huantu(){
        var Link = document.getElementById("007");
        Link.src="http://[2001:da8:270:2021::71]:8082/image/showImg?path=*download*xsg.jpg";
    }
</script>
</body >
</html>
