...
<body>
                 ...
                 <div class="col-md-10">
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <iframe target="blank" id="ifr" scrolling="no" frameborder=0 style="width:800px;height:1400px" src="<%=path %>/myInformation/find.do?userid=<%=id %>"></iframe>
                        </div>    
                    </div><!--/.blog-item-->
    ...
    <script type="text/javascript">
		...
		function select4(){
			...
			Link.src = "<%=path %>/myInformation/find.do";
			return Link.src;
		}
		function select2(){
			Link = document.getElementById("ifr");
			Link.src = "<%=path %>/collection/find.do";
			return Link.src;
		}
		function select3(){
			Link = document.getElementById("ifr");
			Link.src = "<%=path %>/myself/find.do";
			return Link.src;
		}
		function select5(){
			Link = document.getElementById("ifr");
			Link.src = "<%=path %>/MyComment/find.do";
			return Link.src;
		}
	</script>
