                 ...
                 <div class="col-md-10">
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <iframe onclick="select()" id="ifr" scrolling="no" frameborder=0 style="width:800px;height:1320px" src="<%=path %>/tuijian/find.do"></iframe>
                        </div>    
                    </div><!--/.blog-item-->
  ...
  <footer id="footer" class="midnight-blue" style="width:100%; ">
    ...
    <script type="text/javascript">
		...
		function select1(){
			...
			ll.src = "<%=path %>/tuijian/find.do?type="+ii;
			return ll.src;
		}
		function select2(){
			var ii = "b";
