...
<body>
    ...
    <section id="blog" class="container">
        <div class="row">
        	<div class="col-md-3">
        		<h1 style="color:black">&nbsp&nbsp&nbsp&nbsp新&nbsp&nbsp闻</h1>
        	</div>
        </div>
		<div class="row">
    ...
    <section id="blog" class="container">
    	<% for(News n : list){ %>
        <div class="center">
            <h2><%=n.getNewsTitle() %></h2>
            <p class="lead"> <%=n.getNewsAbstract() %></p>
        </div>
        <div class="blog">
            <div class="row">
                <div class="col-md-8">
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="<%=path %>/<%=n.getNewsImage() %>" width="100%" alt="" />
                            <div class="row">  
                            </div>
                        </div><!--/.blog-item-->
