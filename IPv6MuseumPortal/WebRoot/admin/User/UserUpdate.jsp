...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="<%=path %>/user/list.do?p=1&size=5&type=1">用户信息</a></a></dl>
  ...
  <ul>
    ...
    <form class="am-form am-g" action="<%=path%>/user/update.do">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
				    <tr> 
				        <td><strong><input type="hidden" name="userPassword" value="<%=user.getUserPassword() %>"/><input type="hidden" name="userId" value="<%= user.getUserId()%>"><%= user.getUserId() %></strong></td>
