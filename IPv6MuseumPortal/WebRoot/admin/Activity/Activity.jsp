...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 >展厅活动管理</a></dl>
          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/Activity/list.do?p=1&size=5&type=1">«首页</a></li>
                <li><a href="<%=path %>/Activity/list.do?p=<%=nowPage-1 %>&size=5&type=1">上一页</a></li>
                <li><a href="<%=path %>/Activity/list.do?p=<%=nowPage+1 %>&size=5&type=1">下一页</a></li>
                <li><a href="<%=path %>/Activity/list.do?p=<%=maxPage %>&size=5&type=1">末页»</a></li>
              </ul>
