...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="<%=path %>/news/list.do?p=1&size=5">展馆新闻</a></dl>
      
      <dl>
        	<a href="<%=path %>/admin/News/saveNews.jsp" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加新闻</a></button>
      </dl>
          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/news/list.do?p=1&size=5">«首页</a></li>
                <li><a href="<%=path %>/news/list.do?p=<%=nowPage-1 %>&size=5">上一页</a></li>
                <li><a href="<%=path %>/news/list.do?p=<%=nowPage+1 %>&size=5">下一页</a></li>
                <li><a href="<%=path %>/news/list.do?p=<%=maxPage %>&size=5">末页»</a></li>
              </ul>
