...
<div class="admin-biaogelist">
  ...
  <ul>
    ...
    <form class="am-form am-g" action="<%=path%>/news/save.do">
            ...
            <tbody>
				    <tr>
						...
						<td><strong><textarea rows="5" cols="5" name="newsContext"></textarea></strong></td>
						  <td><strong><input type="text" name="newsTime" class="am-form-field am-input-sm am-input-xm" placeholder="格式：yyyy-MM-dd HH:mm:ss" ></strong></td>
				    </tr>
            </tbody>
          </table>
