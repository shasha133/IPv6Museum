          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
   			...
   			<tbody>
				    ...
				    <tr>
					    ...
					    <td><%=e.getExhibitsCherish()%></td>
						<td><div class="am-btn-toolbar">
			                 <div class="am-btn-group am-btn-group-xs">
			                  	<a href="<%=path %>/Collect/findBy.do?ExhibitId=<%=e.getExhibitsId() %>&page=1&size=5" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="查看展品收藏详情"></a>
			                 </div>
			                </div>
			             </td>
				    </tr>
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/Collect/Exlist.do?p=1&size=5">«首页</a></li>
                <li><a href="<%=path %>/Collect/Exlist.do?p=<%=nowPage-1 %>&size=5">上一页</a></li>
                <li><a href="<%=path %>/Collect/Exlist.do?p=<%=nowPage+1 %>&size=5">下一页</a></li>
                <li><a href="<%=path %>/Collect/Exlist.do?p=<%=maxPage %>&size=5">末页»</a></li>
              </ul>
