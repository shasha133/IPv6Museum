          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <!-- <th width="163px" class="table-set">评论状态</th> -->
                <th width="163px" class="table-set">回复</th>
              </tr>
            </thead>
   			<tbody>
		            <%
				    ...
				    <tr>
						...
						<td><div class="am-btn-toolbar">
			                 <div class="am-btn-group am-btn-group-xs">
			                  <a href="<%=path %>/comment/replySkip.do?commentId=<%=comment.getCommentId() %>" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="进行回复"></a>
			             <!-- <a href="<%=path %>/comment/findById.do?commentId=<%=comment.getCommentId() %>" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="屏蔽回复/解除屏蔽"></a> -->
			                 </div>
			                 </div>
			             </td>
				    </tr>
