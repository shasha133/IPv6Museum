          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/Activity/list.do?p=1&size=5&type=2">«首页</a></li>
                <li><a href="<%=path %>/Activity/list.do?p=<%=nowPage-1 %>&size=5&type=2">上一页</a></li>
                <li><a href="<%=path %>/Activity/list.do?p=<%=nowPage+1 %>&size=5&type=2">下一页</a></li>
                <li><a href="<%=path %>/Activity/list.do?p=<%=maxPage %>&size=5&type=2">末页»</a></li>
              </ul>
