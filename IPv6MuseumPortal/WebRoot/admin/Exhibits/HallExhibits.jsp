...
<form class="am-form am-g" method="post" action="<%=path %>/Exhibits/hall.do?page=1&size=5">
            ...
            <tbody>
              <%
				    ...
				    <tr>
					    ...
					    <td><a href="<%=path %>/Exhibits/findById.do?exhibitsId=<%=exhibits.getExhibitsId() %>&type=1"><%= exhibits.getExhibitsName()%></a></td>
        	  ...
        	  <ul class="am-pagination am-fr">
   			    <li><a href="<%=path %>/Exhibits/hall.do?hallId=<%= hId %>&page=1&size=5">«首页</a></li>
                <li><a href="<%=path %>/Exhibits/hall.do?hallId=<%= hId %>&page=<%=nowPage-1 %>&size=5">上一页</a></li>
                <li><a href="<%=path %>/Exhibits/hall.do?hallId=<%= hId %>&page=<%=nowPage+1 %>&size=5">下一页</a></li>
                <li><a href="<%=path %>/Exhibits/hall.do?hallId=<%= hId %>&page=<%=maxPage %>&size=5">末页»</a></li>
             </ul>
