          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
           ...
           <div class="am-btn-group am-btn-group-xs">
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/Record/findBy.do?UserId=<%=UserId %>&ExhibitId=<%=ExhibitId %>&page=1&size=5">«首页</a></li>
                <li><a href="<%=path %>/Record/findBy.do?UserId=<%=UserId %>&ExhibitId=<%=ExhibitId %>&page=<%=nowPage-1 %>&size=5">上一页</a></li>
                <li><a href="<%=path %>/Record/findBy.do?UserId=<%=UserId %>&ExhibitId=<%=ExhibitId %>&page=<%=nowPage+1 %>&size=5">下一页</a></li>
                <li><a href="<%=path %>/Record/findBy.do?UserId=<%=UserId %>&ExhibitId=<%=ExhibitId %>&page=<%=maxPage %>&size=5">末页»</a></li>
              </ul>
