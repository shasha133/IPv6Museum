...
<% List<Activity> list2 = (List<Activity>)request.getAttribute("list2"); %>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-4 wow fadeInDown">
                    <div class="clients-comments text-center">
                        <a href="<%=path %>/ActivityIntroduction/find.do?title=<%=n.getActivityId() %>"><img src="<%=path %>/<%=n.getActivityImage() %>" class="img-circle" alt=""></a>
    ...
    <script type="text/javascript">
    	function change1(){
    		var page = <%=i2 %>;
    		window.location.href='<%=path %>/activity/find.do?page='+page;
    		
    	}
    	function change2(){
    		var page2 = <%=i2 %>;
    		window.location.href='<%=path %>/activity/find.do?page2='+page2;
    		
    	}
    	
		function change(activityId){
			window.location.href='<%=path %>/ActivityIntroduction/find.do?title='+activityId;
		}
	</script>
</body>
</html>