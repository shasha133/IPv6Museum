    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            <li>
                ...
                <br></li>
            <form class="am-form am-g" method="post" action="/Activity/findBy.do?page=1&size=5&type=1">
    ...
    <form class="am-form am-g" method="post" action="/Activity/save">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tr>
                ...
                <input type="hidden" name="activityTop" value="1"/>
                <td><strong><input type="text" name="activityTitle" class="am-form-field am-input-sm am-input-xm" placeholder="必填" ></strong></td>
                ...
                <td><strong><input type="text" name="activityState" class="am-form-field am-input-sm am-input-xm" placeholder="必填" ></strong></td>
            </tr>
            <tr class="am-success">
            ...
            <tr>
                <td><strong><input type="text" name="activityAbstract" class="am-form-field am-input-sm am-input-xm" placeholder="必填" ></strong></td>
            ...
            <tr>
                <td><strong><textarea rows="5" cols="5" name="activityContext" placeholder="必填"></textarea></strong></td>
            </tr>
            </tbody>
        </table>
