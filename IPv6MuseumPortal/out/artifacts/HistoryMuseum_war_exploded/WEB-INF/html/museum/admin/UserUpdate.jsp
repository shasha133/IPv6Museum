...
<div class="admin-biaogelist">
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a
                href="/adminuser/list.do?p=1&size=5&type=1">用户信息</a></dl>
    </div>
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            <li>
                ...
                <br></li>
            <form class="am-form am-g" method="post" method="post" action="/adminuser/findBy?page=1&size=5">
                <li><input type="text" name="userId" class="am-form-field am-input-sm am-input-xm" placeholder="用户ID"/>
                </li>
                <li><input type="text" name="userName" class="am-form-field am-input-sm am-input-xm" placeholder="用户名"/>
                </li>
                <li>
    ...
    <form class="am-form am-g" method="post" action="/adminuser/update">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
            <tr class="am-success">
                <th class="table-title">用户ID</th>
                <th class="table-title">用户名</th>
                <th class="table-type">用户权限（管理员：max，普通用户：min）</th>
            ...
            <tr>
                <td><strong>
                    ...
                    <input type="hidden" name="userId" value="<%= user.getUserId()%>"><%= user.getUserId() %>
                </strong></td>

                <td><strong> <input type="text" name="userName" value="<%=user.getUserName() %>"/></strong></td>
                <td><strong><input type="text" name="userRoot" class="am-form-field am-input-sm am-input-xm" value="<%= user.getUserRoot()%>"></strong></td>
                <td><strong><image style="height:100px;weight:100px" src="<%=user.getUserImage() %>"></image></strong></td>
            </tr>
            </tbody>
        </table>
        <div class="am-btn-group am-btn-group-xs">
