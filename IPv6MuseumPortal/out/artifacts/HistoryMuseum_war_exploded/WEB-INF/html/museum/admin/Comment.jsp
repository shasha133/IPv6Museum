...
<%@ page import="museum.entity.Comment" %>
<%
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="/comment/list?p=1&size=5">评论信息</a></dl>
    </div>
    ...
    <form class="am-form am-g" method="post" action="/comment/delete" method="post">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tr>
                ...
                <td><%=comment.getCommentContent()%>
                </td>
                <td><%=comment.getFromUid()%>
                </td>
                <td><%=comment.getCommentTime()%>
                </td>
                <%
                ...
                <td>
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="/comment/replySkip?commentId=<%=comment.getCommentId() %>"
                               class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file"
                               data-am-modal="{target: '#my-popups'}" title="进行回复"></a>

                            <a href="/comment/findById?commentId=<%=comment.getCommentId() %>"
                               class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file"
                               data-am-modal="{target: '#my-popups'}" title="屏蔽回复/解除屏蔽"></a>
                        </div>
                    </div>
                </td>
            </tr>
        ...
        <ul class="am-pagination am-fr">
            <li><a href="/comment/list?p=1&size=5">«首页</a></li>
            <li><a href="/comment/list?p=<%=nowPage-1 %>&size=5">上一页</a></li>
            <li><a href="/comment/list?p=<%=nowPage+1 %>&size=5">下一页</a></li>
            <li><a href="/comment/list?p=<%=maxPage %>&size=5">末页»</a></li>
        </ul>
        <hr/>
    </form>
</div>
