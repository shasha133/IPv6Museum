...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
        <ul class="am-icon-flag on">  专题讲座管理</ul>

        <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="<%=path %>/Activity/list?p=1&size=5&type=2">专题讲座</a></dl>

        <dl>
            <a href="<%=path %>/admin/Lecture/saveLecture.jsp" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加讲座</a></button>
        </dl>
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            <li>
                ...
                <br></li>
            <form class="am-form am-g" method="post" method="post" action="<%=path %>/Activity/findBy?page=1&size=5&type=2">
    ...
    <form class="am-form am-g" method="post" action="/Activity/update">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
            <tr>
                <td><strong><input type="hidden" name="activityId" value="<%= activity.getActivityId()%>"><%= activity.getActivityId()%></strong></td>
