...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="/Activity/list.do?p=1&size=5&type=1">展厅活动</a></dl>

        <dl>
            <a href="/admin/Activity/saveActivity.jsp" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 发布活动</a></button>
        </dl>
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            <li>
                ...
                <br></li>
            <form class="am-form am-g" method="post" method="post" action="/Activity/findBy.do?page=1&size=5&type=1">
    ...
    <form class="am-form am-g" method="post" action="/Activity/update">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
            <tr>
                <td><strong><input type="hidden" name="type" value="1"/><input type="hidden" name="activityId" value="<%= activity.getActivityId()%>"></strong></td>
                <td><strong><input type="text" name="activityTitle" class="am-form-field am-input-sm am-input-xm" value="<%=activity.getActivityTitle()%>"></strong></td>
                <td><strong><input type="text" name="activityImage" class="am-form-field am-input-sm am-input-xm" value="<%=activity.getActivityImage()%>"></strong></td>
                <td><strong><input type="text" name="activityContext" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityContext()%>"></strong></td>
                <td><strong><input type="text" name="activityAbstract" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityAbstract()%>"></strong></td>
                <td><strong><input type="text" name="activityTime" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityTime()%>"></strong></td>
                <td><strong><input type="text" name="activityTimeStart" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityTimeStart()%>"></strong></td>
                <td><strong><input type="text" name="activityTimeEnd" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityTimeEnd()%>"></strong></td>
				<td><strong><input type="text" name="activityState" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityState()%>"></strong></td>
                <td><strong><input type="text" name="activityTop" class="am-form-field am-input-sm am-input-xm" value="<%= activity.getActivityTop()%>" style="display: none"></strong></td>
            </tr>
            </tbody>
        </table>
