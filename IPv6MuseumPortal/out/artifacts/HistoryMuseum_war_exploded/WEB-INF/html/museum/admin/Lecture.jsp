...
<div class="admin-biaogelist">
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="/Activity/list?p=1&size=5&type=2">专题讲座</a></dl>
        <dl>
            <a href="/admin/Lecture/saveLecture.jsp" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加讲座</a></button>
        </dl>
    </div>
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            ...
            <form class="am-form am-g" method="post" method="post" action="/Activity/findBy?page=1&size=5&type=2">
                <li><input type="text" name="activitytitle" class="am-form-field am-input-sm am-input-xm" placeholder="讲座标题" /></li>
                <li><input type="text" name="activitytime" class="am-form-field am-input-sm am-input-xm" placeholder="讲座发布时间" /></li>
                <li><input type="text" name="activityId" class="am-form-field am-input-sm am-input-xm" placeholder="讲座编号" /></li>
    ...
    <form class="am-form am-g" method="post" action="/Activity/delete" method="post">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tr>
                ...
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="/Activity/findById?activityId=<%=activity.getActivityId() %>&type=2" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="编辑"></a>
                    </div>
                </div>
                </td>
            </tr>
        ...
        <ul class="am-pagination am-fr">
            <li><a href="/Activity/list?p=1&size=5&type=2">«首页</a></li>
            <li><a href="/Activity/list?p=<%=nowPage-1 %>&size=5&type=2">上一页</a></li>
            <li><a href="/Activity/list?p=<%=nowPage+1 %>&size=5&type=2">下一页</a></li>
            <li><a href="/Activity/list?p=<%=maxPage %>&size=5&type=2">末页»</a></li>
        </ul>
