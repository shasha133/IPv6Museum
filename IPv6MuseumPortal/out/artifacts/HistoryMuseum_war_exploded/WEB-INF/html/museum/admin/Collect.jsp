...
<div class="admin-biaogelist">
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            ...
            <form class="am-form am-g" method="post" method="post" action="/Collect/findBy?page=1&size=5">
                ...
                <li><input type="text" name="ExhibitId" class="am-form-field am-input-sm am-input-xm"
                           placeholder="展品Id"/></li>
                <li>
    ...
    <form class="am-form am-g" method="post" action="/Collect/delete" method="post">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
            <tr class="am-success">
                <th class="table-title">展品ID</th>
                <th class="table-title">展品名称</th>
                <th class="table-title">展品收藏次数</th>
            ...
            <tr>
                ...
                <td><%=e.getExhibitsName()%>
                </td>
                <td><%=e.getExhibitsCherish()%>
                </td>
                <td>
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="/Collect/findBy?ExhibitId=<%=e.getExhibitsId() %>&page=1&size=5"
                               class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file"
                               data-am-modal="{target: '#my-popups'}" title="查看展品收藏详情"></a>
                        </div>
                    </div>
                </td>
            </tr>
        ...
        <ul class="am-pagination am-fr">
            <li><a href="/Collect/Exlist?p=1&size=5">«首页</a></li>
            <li><a href="/Collect/Exlist?p=<%=nowPage-1 %>&size=5">上一页</a></li>
            <li><a href="/Collect/Exlist?p=<%=nowPage+1 %>&size=5">下一页</a></li>
            <li><a href="/Collect/Exlist?p=<%=maxPage %>&size=5">末页»</a></li>
        </ul>
        <hr/>
    </form>
</div>
