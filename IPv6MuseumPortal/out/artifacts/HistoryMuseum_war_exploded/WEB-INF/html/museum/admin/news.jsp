...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="/news/list?p=1&size=5">展馆新闻</a></dl>
        <dl>
            <a href="/news/saveNews" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加新闻</a>
        </dl>
    </div>
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            ...
            <form class="am-form am-g" method="post" method="post" action="/news/findBy?page=1&size=5">
    ...
    <form class="am-form am-g" method="post" action="/news/delete" method="post">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tr>
                ...
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="/news/findById?NewsId=<%=news.getNewsId() %>" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="编辑"></a>
                    </div>
                </div>
                </td>
            </tr>
        ...
        <ul class="am-pagination am-fr">
            <li><a href="/news/list?p=1&size=5">«首页</a></li>
            <li><a href="/news/list?p=<%=nowPage-1 %>&size=5">上一页</a></li>
            <li><a href="/news/list?p=<%=nowPage+1 %>&size=5">下一页</a></li>
            <li><a href="/news/list?p=<%=maxPage %>&size=5">末页»</a></li>
        </ul>
        <hr />
        <p>注：.....</p>
    </form>
