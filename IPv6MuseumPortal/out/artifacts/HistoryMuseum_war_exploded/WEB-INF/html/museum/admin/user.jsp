    ...
    <form class="am-form am-g" method="post" action="/adminuser/delete" method="post">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tr>
                ...
                <%}%>
                <td>
                    <image style="height:100px;weight:100px" src="<%=user.getUserImage() %>"></image>
                </td>
                <td>
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="/adminuser/findById?userId=<%= user.getUserId() %>&type=1"
                               class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file"
                               data-am-modal="{target: '#my-popups'}" title="修改用户权限"></a>
                        </div>
                    </div>
                </td>
            </tr>
        ...
        <ul class="am-pagination am-fr">
            <li><a href="/adminuser/list?p=1&size=5&type=1">«首页</a></li>
            <li><a href="/adminuser/list?p=<%=nowPage-1 %>&size=5&type=1">上一页</a></li>
            <li><a href="/adminuser/list?p=<%=nowPage+1 %>&size=5&type=1">下一页</a></li>
            <li><a href="/adminuser/list?p=<%=maxPage %>&size=5&type=1">末页»</a></li>
        </ul>
        <hr/>
        <p>注：.....</p>
    </form>
