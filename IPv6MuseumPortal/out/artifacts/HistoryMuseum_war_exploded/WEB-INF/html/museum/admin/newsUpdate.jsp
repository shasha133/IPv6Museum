...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;"><strong> 当前位置： 首页 &gt; <a href="<%=path %>/news/list?p=1&size=5">展馆新闻</a></strong></dl>

        <dl>
            <strong><button type="button" href="<%=path %>/admin/News/saveNews.jsp" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加新闻</button></strong>
        </dl>
    ...
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
        <ul>
            <li>
                ...
                <br></li>
            <form class="am-form am-g" method="post" action="<%=path %>/news/findBy?page=1&size=5" method="post">
    ...
    <form class="am-form am-g" method="post" action="/news/update">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
            <tr class="am-success">
                <th ><br></th>
                <th class="table-id"><strong>ID</strong></th>
            ...
            <tbody>
            <tr>
                <td><strong><input type="checkbox" name="chs" value="<%=news.getNewsId() %>"></strong></td>
                <td><strong><input type="hidden" name="newsId" value="<%=news.getNewsId() %>"><%= news.getNewsId()%></strong></td>
                <td><strong><input type="text" name="newsTitle" class="am-form-field am-input-sm am-input-xm" value="<%=news.getNewsTitle()%>"></strong></td>
                <td><strong><input type="text" name="newsAbstract" class="am-form-field am-input-sm am-input-xm" value="<%=news.getNewsAbstract()%>"></strong></td>
                <td><strong><input type="text" name="newsContext" class="am-form-field am-input-sm am-input-xm" value="<%=news.getNewsContext()%>"></strong></td>
                <td><strong><input type="text" name="newsImage" class="am-form-field am-input-sm am-input-xm" value="<%=news.getNewsImage()%>"></strong></td>
                <td><strong><input type="text" name="newsTime" class="am-form-field am-input-sm am-input-xm" value="<%=news.getNewsTime().toLocaleString()%>"></strong></td>
            </tr>
            </tbody>
        </table>
