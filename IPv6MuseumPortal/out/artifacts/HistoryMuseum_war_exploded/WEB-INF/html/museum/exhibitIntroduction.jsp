        ...
        <div class="row">
            <div class="col-md-8">
                <div class="blog-item">
                    <img class="img-responsive img-blog"
                         src="http://[2001:da8:270:2021::71]:8082/image/showImg?path=<%=exhibits.getExhibitsImagefull().replace("\\","*")%>" width="100%"
                         alt=""/>
                    <div class="row">
                    </div>
                </div><!--/.blog-item-->
            ...
            <aside class="col-md-3 col-md-offset-1">
                ...
                <div class="widget categories">
                    年&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp代 :&nbsp&nbsp<%=exhibits.getDynastyId() %><br/>
                    材&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp料 :&nbsp&nbsp<%=exhibits.getMaterialId() %><br/>
                    尺&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp寸 :&nbsp&nbsp<%=exhibits.getExhibitsAppearance() %><br/>
                    用&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp途 :&nbsp&nbsp<%=exhibits.getApplyId() %><br/>
                    出土地点 :&nbsp&nbsp<%=exhibits.getExhibitsExcavatePlace() %><br/>
                    生产地点 :&nbsp&nbsp<%=exhibits.getExhibitsProducePlace() %><br/>
                    生产时间 :&nbsp&nbsp<%=exhibits.getExhibitsProduceTime() %><br/>
                    浏览次数 :&nbsp&nbsp<%=exhibits.getExhibitsBrowse() %><br/>
                    收藏次数 :&nbsp&nbsp<%=exhibits.getExhibitsUpvote() %><br/>
                </div>
            </aside>
        </div>
    </div>
...
<!-- jQuery --> <script src="../resourcesOne/bootStrap/jquery.min.js"></script> <!-- Bootstrap --> <script src="../resourcesOne/bootStrap/bootstrap.min.js"></script> <script src="../resourcesOne/js/jquery.prettyPhoto.js"></script> <script src="../resourcesOne/js/jquery.isotope.min.js"></script> <script src="../resourcesOne/js/main.js"></script> <script src="../resourcesOne/js/jquery.js"></script> <script src="../resourcesOne/js/wow.min.js"></script>
</body>
</html>