    	...
    	<div class="row clearfix">
					...
					<div class="col-md-4 col-sm-6">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<form id="form01" action="<%=path %>/cangPin3/find2.do">
									<input type="hidden" name="xxx" value="<%=id %>" />
									<input type="hidden" name="ExhibitsId" value="<%=n.getExhibitsId() %>" />
									<a target="blank" style="cursor:pointer" onclick="open1()" ><img style="width:100px;height:100px" class="media-object" src="<%=n.getExhibitsImagefull() %>" alt=""></a>
								</form>
