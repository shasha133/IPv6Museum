          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
				    ...
				    <tr>
						...
						%>
						 ...
						 <%
						  ...
						  %>
						<td><image style="height:100px;weight:100px" src="<%=user.getUserImage() %>"></image></td>
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/user/list.do?p=1&size=5&type=1">«首页</a></li>
                <li><a href="<%=path %>/user/list.do?p=<%=nowPage-1 %>&size=5&type=1">上一页</a></li>
                <li><a href="<%=path %>/user/list.do?p=<%=nowPage+1 %>&size=5&type=1">下一页</a></li>
                <li><a href="<%=path %>/user/list.do?p=<%=maxPage %>&size=5&type=1">末页»</a></li>
              </ul>
