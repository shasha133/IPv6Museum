...
%>
<%
	List<Comment> list=(List<Comment>)request.getAttribute("SearchList");
	String commentId=String.valueOf(request.getAttribute("commentId"));
	String commentTime=String.valueOf(request.getAttribute("commentTime"));
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 ><a href="<%=path %>/comment/list.do?p=1&size=5">评论信息</a></dl>
  ...
  <ul>
    ...
    <form class="am-form am-g" action="<%=path %>/comment/delete.do" method="post">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <!-- <th width="163px" class="table-set">查看回复</th> -->
              </tr>
            </thead>
   			<tbody>
		            <%
		             ...
		             %> 
				    <tr>
				        <td><input type="checkbox" name="id" value="<%=comment.getCommentId() %>" /></td>
						...
						<td><div class="am-btn-toolbar">
			                 <div class="am-btn-group am-btn-group-xs">
			                  <!-- <a href="<%=path %>/comment/findById.do?commentId=<%=comment.getCommentId() %>" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="查看本条品论回复"></a> -->
			                 </div>
			                 </div>
			             </td>
				    </tr>
          	...
          	<ul class="am-pagination am-fr">
                <li><a href="<%=path %>/comment/list.do?p=1&size=5">«首页</a></li>
                <li><a href="<%=path %>/comment/list.do?p=<%=nowPage-1 %>&size=5">上一页</a></li>
                <li><a href="<%=path %>/comment/list.do?p=<%=nowPage+1 %>&size=5">下一页</a></li>
                <li><a href="<%=path %>/comment/list.do?p=<%=maxPage %>&size=5">末页»</a></li>
              </ul>
