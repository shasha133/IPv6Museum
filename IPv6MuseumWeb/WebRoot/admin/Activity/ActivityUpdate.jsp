...
<div class="admin-biaogelist">
  ...
  <ul>
    ...
    <form class="am-form am-g" action="<%=path%>/Activity/update.do">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
				    <tr> 
				        <td><strong><input type="hidden" name="type" value="1"/><input type="hidden" name="activityId" value="<%= activity.getActivityId()%>"><%= activity.getActivityId()%></strong></td>
