...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"><strong> 当前位置：首页 ><a href="<%=path %>/Activity/list.do?p=1&size=5&type=1">展厅活动</a></a></strong></dl>
  ...
  <ul>
    ...
    <form class="am-form am-g" method="post" enctype="multipart/form-data" action="<%=path%>/Activity/up.do?aId=<%=activity.getActivityId() %>">
