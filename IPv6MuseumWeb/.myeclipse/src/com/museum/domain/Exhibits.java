...
public class Exhibits implements java.io.Serializable {
	...
	public Exhibits(Nation nation, Apply apply, State state, Dynasty dynasty,
			...
			String exhibitsDetail, String exhibitsVoice, String exhibitsImage,
			Integer exhibitsUpvote, Integer exhibitsBrowse,
			String exhibitsDamage) {
		this.nation = nation;
		this.apply = apply;
		this.state = state;
		...
		this.exhibitsImage = exhibitsImage;
	...
	public String getExhibitsImage() {
		return this.exhibitsImage;
	}

	public void setExhibitsImage(String exhibitsImage) {
		this.exhibitsImage = exhibitsImage;
	}
